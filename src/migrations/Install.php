...
class Install extends Migration
{
    ...
    {
        Db::dropAllForeignKeysToTable('{{%bundles_bundles}}');
        Db::dropAllForeignKeysToTable('{{%bundles_purchasables}}');
        Db::dropAllForeignKeysToTable('{{%bundles_bundletypes}}');
        Db::dropAllForeignKeysToTable('{{%bundles_bundletypes_sites}}');
    }
}
